...
/**
 * Trava de acesso ao título "Barbie: Life in the Dreamhouse".
 *
 * Mesmo padrão do ColorirGate: código de liberação salvo para sempre neste
 * aparelho (localStorage), com opção de ir direto ao checkout.
 */
...
export function BarbieDreamhouseGate({
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Liberar acesso a Barbie: Life in the Dreamhouse"
      ...
      <div className="relative my-8 w-full max-w-[460px] overflow-hidden rounded-[24px] border border-white/10 bg-[#2a0f22] shadow-[0_30px_80px_rgba(0,0,0,0.6)]">
        ...
        <div className="px-6 pb-6 pt-2 text-center sm:px-8">
          ...
          <p className="mt-1 text-sm text-white/70">
            Desenho liberado somente para o MeninasFlix Combo
          </p>
          <p className="mx-auto mt-2 max-w-[340px] text-sm leading-relaxed text-white/70">
            Essa coleção ainda não faz parte do seu acesso. Você pode liberar agora e assistir na
            hora.
          </p>
          ...
          <div className="mt-5 rounded-2xl border border-[#e6b34d]/60 bg-[#e6b34d]/[0.06] p-4 text-left">
            ...
            <div className="mt-3 flex gap-2">
              <input
                ...
                placeholder="EX.: barbielifeinthedreamhouse"
